              ...
              <div className="space-y-3">
                {students.length === 0 ? (
                  ...
                  students.slice(0, 5).map((student, index) => (
                    <div key={student.studentId || index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                {students.length === 0 ? (
                  ...
                  students.slice(0, 5).map((student, index) => (
                    <div key={student.studentId || index} className="flex items-start gap-3">
